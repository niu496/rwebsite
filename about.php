...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand" href="#">Rwebsite</a>
...
<div class="container">
  <div class="jumbotron my-1" >
    <h1>Rwebsite</h1>
    <p>Rwebsite is the most popular HTML, CSS, and JS framework for developing
...
<div class="container">
 ...
 <div class="row">
 	...
 	<div class="col-lg-6 col-md-6 col-12">
 		<img src="image/7.jpg" class="img-fluid aboutimg">
 	</div>
...
<footer>
  <p class="p-3 bg-dark text-white text-center">@rwebsite</p>
</footer>
